window.rules = [{
  ...
  "rules": [{
    ...
    "link": "refactoring",
    "label": "Refactoring",
    "content": "Include refactoring in your development process. Do it when possible on small parts, before it will mean spending 3 days on refactoring half of application."
  }, {
    "link": "dry-kiss",
    "label": "DRY KISS",
  ...
  "rules": [{
    ...
    "link": "caniuse",
    "label": "Can I use",
    "content": "Great for ensuring browser support. %http://caniuse.com% ."
  }, {
    "link": "method-length",
    "label": "Method length",
  ...
  "rules": [{
    "link": "tag-usage",
    "label": "Tag usage",
    "content": "Use correct tags for your purposes. HTML5 introduced new tags that can be used in your RIA/SPA."
  }, {
    "link": "script-tag",
    "label": "Script tag",
  ...
  "rules": [{
    ...
    "content": "Prefer .bind(), .call(), .apply()."
  }, {
    "link": "inline-anonymous-functions",
    "label": "Inline anonymous functions",
    "content": "Do not use inline and/or anonymous functions longer than 2-3 lines."
  }, {
    ...
    "link": "return-values",
    "label": "Return values",
    "content": "Always ensure that functions return correct values. If no value is expected, return this (for chaining) or false (oldschool cancel events), but be consistent."
  }, {
    "link": "strict-mode",
    "label": "Strict mode",
  ...
  "link": "javascript-oop",
  "label": "Javascript OOP",
  "rules": [{
    "link": "private-methods-and-variables",
    "label": "Private methods and variables",
    "content": "Define private methods and variables starting with _, or if context free, outside class/object."
  }, {
    "link": "delete",
    "label": "Delete",
    "content": "Deoptimizes code. Avoid using it, unless you need to remove property key. Prefer setting value to undefined."
  }]
}, {
  ...
  "rules": [{
    ...
    "link": "pure-js",
    "label": "Pure JS",
    "content": "Many things can be done without using jQuery."
  }]
}, {
  "link": "lodash",
  "label": "Lodash",
  ...
  "rules": [{
    ...
    "content": "Use autoprefixer or create mixins for vendor prefixes to ensure the property gets applied."
  }, {
    ...
    "content": "Group all colors, google \"friendly sass color names\" for techniques."
  }, {
    "link": "zindex",
    "label": "Z-index",
